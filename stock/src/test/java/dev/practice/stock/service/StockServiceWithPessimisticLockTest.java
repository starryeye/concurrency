...
@SpringBootTest
class StockServiceWithPessimisticLockTest {

    @Autowired
    private StockServiceWithPessimisticLock stockServiceWithPessimisticLock;
    ...
    void decreaseStock() {
        ...
        stockServiceWithPessimisticLock.decreaseStock(testId, 10L);
    ...
    void concurrencyTestByThread100() {
        ...
        for (int i = 0; i < threadCount; i++) {
            executorService.execute(() -> {
                try {
                    stockServiceWithPessimisticLock.decreaseStock(testId, 1L);
                } finally {
