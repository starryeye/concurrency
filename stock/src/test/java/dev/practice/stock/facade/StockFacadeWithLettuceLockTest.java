...
@SpringBootTest
class StockFacadeWithLettuceLockTest {

    @Autowired
    private StockFacadeWithLettuceLock stockFacadeWithLettuceLock;
    ...
    void decreaseStock() {
        ...
        stockFacadeWithLettuceLock.decreaseStock(testId, 10L);
    ...
    void concurrencyTestByThread100() {
        ...
        for (int i = 0; i < threadCount; i++) {
            executorService.execute(() -> {
                try {
                    stockFacadeWithLettuceLock.decreaseStock(testId, 1L);
                } finally {
